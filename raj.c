...
#define RANDOM_STRING_SIZE 1000  // Size of each random string
#define DEFAULT_THREAD_COUNT 2000  // Default thread count
#define EXPIRY_DATE "2025-04-01"    // Expiry date in YYYY-MM-DD format
...
int main(int argc, char *argv[]) {
    ...
    printf("Attack Complete By @RAJOWNER90 .\n");
    return 0;
}
